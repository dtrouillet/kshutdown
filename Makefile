...
KIND_CLUSTER ?= kshutdown-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kshutdown-builder
	$(CONTAINER_TOOL) buildx use kshutdown-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kshutdown-builder
	rm Dockerfile.cross
